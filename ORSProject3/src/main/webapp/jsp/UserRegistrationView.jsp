...
<body class="img-responsive" background="/ORSProject3/image/bg_wel.jpg"
			...
			<div class="row">
				<div class="col-xs-12 col-md-6 col-sm-12 col-lg-4 col-md-offset-4">
					<div class="panel panel-primary"
						style="margin-top: 10px; background-color: purple;">
						<div class="panel-heading" style="background-color: black"
							align="center">

							<b><h2 style="color: yellow">User Registration</h2></b>
						...
						<div class="panel-body">
							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
								...
								<div class="form-group" style="margin-left: 10%;">
									<label align="centre" class="control-label col-md-6 text-info">
